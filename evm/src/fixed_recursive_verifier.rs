    ...
    C::Hasher: AlgebraicHasher<F>,
{
    ...
    /// While the [`AllRecursiveCircuits`] prover state can also verify proofs, this allows verifiers
    /// with lighter capacities to only load the necessary data to verify block proofs.
    ///
    /// # Usage
    ///
    /// ```ignore
