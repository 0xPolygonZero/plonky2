...
bn_add_return:
    ...
    %stack (parent_ctx, x, y) -> (parent_ctx, @SEGMENT_RETURNDATA, x, bn_add_contd6, parent_ctx, y)
    %build_address_no_offset
    %mstore_unpacking_32
bn_add_contd6:
    POP
    %stack (parent_ctx, y) -> (parent_ctx, @SEGMENT_RETURNDATA, 32, y, pop_and_return_success)
    %build_address
    %mstore_unpacking_32
