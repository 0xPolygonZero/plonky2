...
prefix_f8_to_ff:
    ...
    PUSH read_list_given_len
    // stack: read_list_given_len, len_of_len, addr, segment, retdest
    SWAP1
    // stack: len_of_len, read_list_given_len, addr, segment, retdest
    %jump read_int_given_len
