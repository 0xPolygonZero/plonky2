...
// Let `(Qxi, Qyi) = i * Q`, then store in the `SEGMENT_KERNEL_BN254_TABLE_Q` segment of memory the values
...
global bn_precompute_table_loop:
    ...
    %mstore_kernel(@SEGMENT_KERNEL_BN254_TABLE_Q) %mstore_kernel(@SEGMENT_KERNEL_BN254_TABLE_Q)
    // stack: i, Qx2, Qy2, Qx, Qy, retdest
