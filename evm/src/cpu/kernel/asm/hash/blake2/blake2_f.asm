global blake2_f:
    ...
    %rep 4
        ...
        DUP1
        // stack: i, i, addr, val, next_val,...
        %blake2_iv
        // stack: IV_i, i, addr, val, next_val,...
        DUP4
        // stack: val, IV_i, i, addr, val, next_val,...
        XOR
        // stack: val ^ IV_i, i, addr, val, next_val,...
        DUP3
        // stack: addr, val ^ IV_i, i, addr, val, next_val,...
        %swap_mstore
        // stack: i, addr, val, next_val,...
        %increment
