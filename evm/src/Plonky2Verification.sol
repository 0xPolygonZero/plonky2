...
contract Plonky2Verification {
    ...
    function serializeTrieRoots(TrieRoots memory trieRoots) public {
    ...
    function serializeBlockMetadata(BlockMetadata memory blockMetadata) public {
        abi.encodePacked(
    ...
    function serializeBlockHashes(BlockHashes memory blockHashes) public {
    ...
    function serializeExtraBlockData(ExtraBlockData memory extraBlockData) public {
        abi.encodePacked(
    ...
    function serializePublicValues(PublicValues memory publicValues) public {
