...
\begin{enumerate}[align=left]
  ...
  initial address + the length of the byte sequence being written to memory. Note that similarly to PUSH (0x60-0x7F) instructions, there are 31 MSTORE\_32BYTES instructions, each
...
Every CPU instruction performs between 0 and 2 pops, and may push at most once. However, for efficiency purposes, we hold the top of the stack in
