...
pub(crate) struct RandomAccessGate<F: PlonkyField<D>, const D: usize> {
    pub bits: usize,
    pub num_copies: usize,
    _phantom: PhantomData<F>,
}

impl<F: PlonkyField<D>, const D: usize> RandomAccessGate<F, D> {
...
impl<F: PlonkyField<D>, const D: usize> Gate<F, D> for RandomAccessGate<F, D> {
    fn id(&self) -> String {
        format!("{:?}<D={}>", self, D)
    }
...
impl<F: PlonkyField<D>, const D: usize> PackedEvaluableBase<F, D> for RandomAccessGate<F, D> {
...
#[derive(Debug)]
struct RandomAccessGenerator<F: PlonkyField<D>, const D: usize> {
    gate_index: usize,
    gate: RandomAccessGate<F, D>,
    copy: usize,
}

impl<F: PlonkyField<D>, const D: usize> SimpleGenerator<F> for RandomAccessGenerator<F, D> {
