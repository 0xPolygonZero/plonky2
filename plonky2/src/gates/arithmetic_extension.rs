...
// | Wires |  x* |   y*  |   z*   | output* |
// +-------+-----+-------+--------+---------+
// | Index | 4Di | 4Di+D | 4Di+2D |  4Di+3D |
// +-------+-----+-------+--------+---------+
//
// NB: Wires followed by a "*" represent extension field element and are composed of `D` wires,
//     where `D` is the extension field degree.
//
// Constraints:
// - `output - (c0 * x * y + c1 * z)`
#[derive(Debug, Clone)]
