...
pub(crate) fn prove<F: Field64 + Extendable<D>, const D: usize>(
...
fn all_wires_permutation_partial_products<F: Field64 + Extendable<D>, const D: usize>(
...
fn wires_permutation_partial_products<F: Field64 + Extendable<D>, const D: usize>(
    witness: &MatrixWitness<F>,
    beta: F,
    gamma: F,
    prover_data: &ProverOnlyCircuitData<F, D>,
...
fn compute_zs<F: Field64 + Extendable<D>, const D: usize>(
...
fn compute_z<F: Field64 + Extendable<D>, const D: usize>(
...
fn compute_quotient_polys<'a, F: Field64 + Extendable<D>, const D: usize>(
    common_data: &CommonCircuitData<F, D>,
