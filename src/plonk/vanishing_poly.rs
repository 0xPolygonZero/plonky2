...
pub(crate) fn eval_vanishing_poly<F: Field64 + Extendable<D>, const D: usize>(
...
pub(crate) fn eval_vanishing_poly_base<F: Field64 + Extendable<D>, const D: usize>(
    common_data: &CommonCircuitData<F, D>,
    index: usize,
    x: F,
...
pub fn evaluate_gate_constraints<F: Field64 + Extendable<D>, const D: usize>(
...
pub fn evaluate_gate_constraints_base<F: Field64 + Extendable<D>, const D: usize>(
    gates: &[PrefixedGate<F, D>],
    num_gate_constraints: usize,
    vars: EvaluationVarsBase<F>,
) -> Vec<F> {
...
pub fn evaluate_gate_constraints_recursively<F: Field64 + Extendable<D>, const D: usize>(
...
pub(crate) fn eval_vanishing_poly_recursively<F: Field64 + Extendable<D>, const D: usize>(
    builder: &mut CircuitBuilder<F, D>,
    common_data: &CommonCircuitData<F, D>,
    x: ExtensionTarget<D>,
