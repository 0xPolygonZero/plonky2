...
pub(crate) fn eval_l_1_recursively<F: Field64 + Extendable<D>, const D: usize>(
...
pub(crate) fn reduce_with_powers_ext_recursive<F: Field64 + Extendable<D>, const D: usize>(
    builder: &mut CircuitBuilder<F, D>,
