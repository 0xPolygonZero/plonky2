...
pub(crate) fn test_low_degree<F: Field64 + Extendable<D>, G: Gate<F, D>, const D: usize>(gate: G) {
...
pub(crate) fn test_eval_fns<F: Field64 + Extendable<D>, G: Gate<F, D>, const D: usize>(
    gate: G,
) -> Result<()> {
